      ...
      <div className="mt-12 md:mt-24">
        ...
        >
              ...
              <div className="select-none pointer-events-none absolute -top-8 -right-6 md:-top-16 md:-right-40 text-xs text-white/70">
                <div className="relative flex items-center justify-end">
                  ...
                  <div className="-mt-6 md:-mt-10 shrink-0">
                    ...
                    <span className="text-[#a78bfa]">Amir Ali batouii</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="md:pl-2 text-center md:text-left">
            ...
            <p className="mt-2 text-[10px] md:text-xs text-white/50 max-w-md md:max-w-lg mx-auto md:mx-0">
              ...
              php, javascript, and Tailwind CSS.
            </p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.15} className="mt-16 max-w-3xl">
          ...
          <p className="mt-3 text-white/80 leading-7">
            Currently, I'm a freelance Frontend Developer I work on platforms,
            UI optimization, and modernizing frontend architecture.
          </p>

          <p className="mt-6 text-white/70 leading-7">
            specializes in PHP development and advanced WordPress customization.
            With strong SEO expertise, delivers optimized, fast, and
            search-engine-friendly websites. focus is on clean architecture,
            performance optimization, and producing reliable, high-quality
            results.
          </p>
        </ScrollReveal>
      </div>
