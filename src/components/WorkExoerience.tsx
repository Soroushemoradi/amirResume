...
const experienceItems: ExperienceItem[] = [
  {
    title: "Introducing Bhutia Energy Green Development Company",
    description:
  ...
  {
    title:
      "Introducing the company supplying industrial machinery and their spare parts",
    description:
  ...
  {
    title: "Mobile phone store project",
    description:
  ...
  {
    title: "Compressor sales store project",
    description:
